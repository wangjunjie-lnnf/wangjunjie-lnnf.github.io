...
class ASTContext : public RefCountedBase<ASTContext> {
    mutable llvm::ContextualFoldingSet<FunctionProtoType, ASTContext&> FunctionProtoTypes;
}
...
private: 
    ...
    /// DeclsInScope - This keeps track of all declarations in this scope. 
    /// When the declaration is added to the scope, it is set as the current
    ...
    /// For example, the entity of a class scope is the class itself, 
    /// the entity of a function scope is a function, etc.
    DeclContext *Entity;
}
